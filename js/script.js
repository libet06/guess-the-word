...
const makeGuess = function (guess) {
    ...
    if (guessedLetters.includes(guess)) {
        message.innerText = "This letter has already been guessed!";
    } else {
...
const updateGuessesRemaining = function (guess) {
  ...
  if (remainingGuesses === 0) {
    ...
    remainingGuessesSpan.innerText = `${remainingGuesses} more guess`;
  } else {
...
const startOver = function () {
  ...
  remainingGuessesElements.classList.add("hide");
